...
<html>
	...
	<body>
		<div>
			...
			<p><?php esc_html_e( 'If you\'re still thinking it over, no rush! We\'re here if you have any questions or need help deciding if it\'s the right fit for you.', 'product-availability-notifier-for-woocommerce' ); ?></p>
			...
			<p><?php esc_html_e( 'Sometimes all it takes is a second look.', 'product-availability-notifier-for-woocommerce' ); ?></p>

			<p><?php esc_html_e( 'Thanks again for your interest!', 'product-availability-notifier-for-woocommerce' ); ?></p>
		</div>
	</body>
</html>
