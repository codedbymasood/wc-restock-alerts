...
<html>
	<head>
		<title>Your <?php echo esc_html( $amount ); ?><?php echo ( 'percent' === $discount_type ) ? '%' : ''; ?> Discount Is About to Expire</title>
	</head>
	<body>
		<div>
			<p>Hi,</p>

			<p>Just a quick reminder - your <?php echo esc_html( $amount ); ?><?php echo ( 'percent' === $discount_type ) ? '%' : ''; ?> off discount code is expiring in <?php echo esc_html( $coupon_expires_in ); ?> days!</p>
